...
<div aria-required="true" class="form-group required form-group-default {{ $errors->has('name') ? 'has-error' : ''}}">
    <label for="price_quotation_line">Price Quotation Line<span class="asctric">*</span></label>
     <input type="text" name="price_quotation_line" id="price_quotation_line" class="form-control" value="{{ !empty($model->price_quotation_line)?$model->price_quotation_line:''}}" autocomplete="off" maxlength="50" required/>
