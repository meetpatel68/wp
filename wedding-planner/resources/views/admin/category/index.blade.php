            ...
            <div class="card">
                <div class="card-block">
                    ...
                    <div class="table-overflow">
                        <table id="category-table" class="table table-lg table-hover" width="100%">
                            <thead>
                                <tr>
                                    <th>*</th>
                                    <th>Name</th>
                 ...
                 <div class="card-footer">
                    <a href="{{ route('category.create') }}" class="btn btn-primary btn-rounded">Add New Category</a>
                </div>
            </div>
        </div>
    </div>
    ...
    buttons: [
        {
            ...
            customize: function ( win ) {
                $(win.document.body)
                    .css( 'padding', '2px' )
                    .prepend(
                        '<img src="{{asset('img/logo.png')}}" style="float:right; top:0; left:0;height: 40px;right: 10px;background: #101010;padding: 8px;border-radius: 4px" /><h5 style="font-size: 9px;margin-top: 0px;"><br/><font style="font-size:14px;margin-top: 5px;margin-bottom:20px;"> Report Category</font><br/><br/><font style="font-size:8px;margin-top:15px;">{{date('Y-m-d h:i:s')}}</font></h5><br/><br/>'
                    );
...
$("#category-table_wrapper > .dt-buttons").appendTo("div.export-options-container");
...
function deleteRecord(){
    ...
    $.ajax({
        url: '{{route("category.index")}}' + "/" + id + '?' + $.param({"_token" : '{{ csrf_token() }}' }),
        type: 'DELETE',
